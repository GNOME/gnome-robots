...
impl Category {
    ...
    pub fn name(&self) -> Option<String> {
        match (self.key.as_str(), self.safety) {
            ("classic_robots", MoveSafety::Unsafe) => Some(N_("Classic robots")),
            ("classic_robots", MoveSafety::Safe) => Some(N_("Classic robots with safe moves")),
            ("classic_robots", MoveSafety::SuperSafe) => {
                Some(N_("Classic robots with super-safe moves"))
            }
            ("nightmare", MoveSafety::Unsafe) => Some(N_("Nightmare")),
            ("nightmare", MoveSafety::Safe) => Some(N_("Nightmare with safe moves")),
            ("nightmare", MoveSafety::SuperSafe) => Some(N_("Nightmare with super-safe moves")),
            ("robots2", MoveSafety::Unsafe) => Some(N_("Robots2")),
            ("robots2", MoveSafety::Safe) => Some(N_("Robots2 with safe moves")),
            ("robots2", MoveSafety::SuperSafe) => Some(N_("Robots2 with super-safe moves")),
            ("robots2_easy", MoveSafety::Unsafe) => Some(N_("Robots2 easy")),
            ("robots2_easy", MoveSafety::Safe) => Some(N_("Robots2 easy with safe moves")),
            ("robots2_easy", MoveSafety::SuperSafe) => {
                Some(N_("Robots2 easy with super-safe moves"))
            }
            ("robots_with_safe_teleport", MoveSafety::Unsafe) => {
                Some(N_("Robots with safe teleport"))
            }
            ("robots_with_safe_teleport", MoveSafety::Safe) => {
                Some(N_("Robots with safe teleport with safe moves"))
            }
            ("robots_with_safe_teleport", MoveSafety::SuperSafe) => {
                Some(N_("Robots with safe teleport with super-safe moves"))
            }
            _ => None,
        }
    }
