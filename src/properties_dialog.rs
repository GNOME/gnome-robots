...
pub fn show_preferences(
    ...
    let configuration_page = adw::PreferencesPage::builder().title(&g_("Game")).build();
...
fn create_game_group(
    ...
    let super_safe_chkbox = adw::SwitchRow::builder()
        .title(&g_("U_se super safe moves"))
        .use_underline(true)
        .subtitle(&g_("Prevents all moves that result in getting killed."))
