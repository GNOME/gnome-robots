...
use gtk::{gdk, gio, gio::prelude::*, glib};
...
impl Properties for gio::Settings {
    ...
    fn set_safe_moves(&self, value: bool) {
        self.set_boolean(SAFE_MOVES, value);
    }
    ...
    fn set_super_safe_moves(&self, value: bool) {
        self.set_boolean(SUPER_SAFE_MOVES, value);
    }
    ...
    fn set_sound(&self, value: bool) {
        self.set_boolean(ENABLE_SOUND, value);
    }
    ...
    fn set_show_toolbar(&self, value: bool) {
        self.set_boolean(SHOW_TOOLBAR, value);
    }
    ...
    fn set_bgcolour(&self, value: gdk::RGBA) {
        self.set_string(BACKGROUND_COLOR, &value.to_string());
    }
    ...
    fn set_selected_config(&self, value: &str) {
        self.set_string(GAME_CONFIGURATION, value);
    }
    ...
    fn set_control_key(&self, k: &ControlKey, key: gdk::Key) {
        self.set_int(&k.settings_key, key_into_i32(key));
    }
